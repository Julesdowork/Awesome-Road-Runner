public class MyTags
{
    ...
    public static string T_REX = "T-Rex";

    // Sorting Layers
    public static string SL_TOP_NEAR_GROUND = "Top Near Ground";
    public static string SL_TREE_TOP = "Tree Top";
    public static string SL_BOTTOM_NEAR_GROUND = "Bottom Near Ground";
    public static string SL_TREE_BOTTOM = "Tree Bottom";
}
